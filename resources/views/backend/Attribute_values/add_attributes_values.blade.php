            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{route('admin.attributes.add', $id)}}" class="btn btn-sm btn-neutral">New</a>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">Add New Attributes Value</h3>
                    </div>
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.attributes.store_value')}}" method="post" role="form">
                    @csrf
                    <div class="pl-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="input-username"
                                           ...
                                           placeholder="Value" name="value" value="{{old('value')}}">
