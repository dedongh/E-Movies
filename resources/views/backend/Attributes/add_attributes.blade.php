        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">Add New Attributes</h3>
                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input class="custom-control-input" name="is_filterable" id="customCheck1"
                                               type="checkbox">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input class="custom-control-input" name="is_required" id="customCheck2"
                                               type="checkbox">
