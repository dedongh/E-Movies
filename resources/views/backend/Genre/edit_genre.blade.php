    ...
    <div class="container-fluid mt--6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.genre.update')}}" method="post" enctype="multipart/form-data" role="form">
                    @csrf
                    <div class="pl-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="input-username"
                                           ...
                                           placeholder="Name" name="name" value="{{old('name', $targetGenre->name)}}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="input-email" name="description" class="form-control"
                                              placeholder="description">{{old('description', $targetGenre->description)}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id"
                                        ...
                                        @foreach($genres as $genre)
                                            @if($targetGenre->parent_id == $genre->id)
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input class="custom-control-input" name="featured" id="customCheck1"
                                               type="checkbox"  {{$targetGenre->feature == 1 ? 'checked':''}}>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input class="custom-control-input" name="menu" id="customCheck2"
                                               type="checkbox"  {{$targetGenre->menu == 1 ? 'checked':''}}>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input class="custom-control-input" name="status" id="customCheck3"
                                               type="checkbox"  {{$targetGenre->status == 1 ? 'checked':''}}>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    @if ($targetGenre->image != null)
                                        <img src="{{asset('storage/'.$targetGenre->image) }}"
