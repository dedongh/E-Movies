                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-username">Footer Copyright Text</label>
                                            <input type="text" id="input-username" name="footer_copyright_text" class="form-control"
                                                   placeholder="copyright text" value="{{config('settings.footer_copyright_text')}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-email">SEO Meta Title</label>
                                            <input type="text" name="seo_meta_title" id="input-email" class="form-control"
                                                   placeholder="admin@example.com" value="{{config('settings.seo_meta_title')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-first-name">SEO Meta Description</label>
                                            <textarea type="text" name="seo_meta_description" id="input-first-name" class="form-control"
                                                      placeholder="SEO Meta Description">{{config('settings.seo_meta_description')}}</textarea>
                                        </div>
                                    </div>
                                </div>
