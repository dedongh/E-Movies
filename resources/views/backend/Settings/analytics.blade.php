                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-username">Google Analytics Code</label>
                                            <textarea id="input-username" name="footer_copyright_text" class="form-control"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-email">Facebook Pixel Code</label>
                                            <textarea name="facebook_pixels" id="input-email" class="form-control"
